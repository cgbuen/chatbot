...
app.get('/settings.json', require('./endpoints/json-settings'))
app.get('/internal-stats.json', require('./endpoints/json-internal-stats'))
app.get('/internal-alerts.json', require('./endpoints/json-internal-alerts'))
...
app.post('/eventsub-callback', require('./endpoints/eventsub'))
